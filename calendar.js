(function(){
  ...
  function openEvent(id){
    ...
    $("#eventModalTitle").textContent=e?"Edit event":"Add event";$("#eventTitle").value=e?.title||"";$("#eventDate").value=e?.date||dk(state.calCursor);$("#eventEndDate").value=e?.endDate||e?.date||dk(state.calCursor);$("#eventAllDay").checked=e?.allDay??!e?.time;$("#eventTime").value=e?.time||"";$("#eventEnd").value=e?.end||"";$("#eventRecurrence").value=e?.recurrence||(e?.calendarId==="birthdays"?"yearly":"");$("#eventRecurrenceUntil").value=e?.recurrenceUntil||"";$("#eventNotify").checked=!!e?.notification?.enabled;setTimeWheel("eventNotify",e?.notification?.time||legacyReminderTime(e));$("#eventNotifyScope").value=e?.notification?.scope||"every";$("#eventNotifyDays").value=e?.notification?.days||"start";$("#eventCalendar").innerHTML=options();$("#eventCalendar").value=e?.calendarId||"mine";$("#deleteEvent").classList.toggle("hidden",!e);toggleEventTimes();toggleRecurrenceUntil();openModal("#eventModal");
  }
  ...
  function toggleRecurrenceUntil(){$("#eventRecurrenceUntilField").classList.toggle("hidden",!$("#eventRecurrence").value)}
