(function(){
  ...
  function openEvent(id){
    ...
    $("#eventModalTitle").textContent=e?"Edit event":"Add event";$("#eventTitle").value=e?.title||"";$("#eventDate").value=e?.date||dk(state.calCursor);$("#eventEndDate").value=e?.endDate||e?.date||dk(state.calCursor);$("#eventAllDay").checked=e?.allDay??!e?.time;$("#eventTime").value=e?.time||"";$("#eventEnd").value=e?.end||"";$("#eventNotify").checked=!!e?.notification?.enabled;$("#eventNotifyLead").value=String(e?.notification?.leadMinutes||0);$("#eventNotifyScope").value=e?.notification?.scope||"every";$("#eventNotifyDays").value=e?.notification?.days||"start";$("#eventCalendar").innerHTML=options();$("#eventCalendar").value=e?.calendarId||"mine";$("#deleteEvent").classList.toggle("hidden",!e);toggleEventTimes();openModal("#eventModal");
  }
