(function(){
  ...
  function openEvent(id){
    const e=id?state.planner.events.find(x=>x.id===id):null;state.editEvent=id||null;const mo=$("#eventMoreOptions"),moc=$("#eventMoreOptionsContent");if(mo&&!mo.dataset.wired){mo.dataset.wired="1";mo.onclick=()=>{const isHidden=moc.classList.toggle("hidden");mo.textContent=isHidden?"More options":"Fewer options"}}
