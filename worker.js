...
export default {
  async fetch(request, env) {
    ...
    if (url.pathname === "/health") return json({ ok: true, app: "OpalDay", version: "1.5.0", notifications: true, reminderTimes: "individual-first", recurringEvents: "advanced", habitOccurrences: true, widgetToday: true, widgetSchema: 2, widgetSlots: "display-safe" });
